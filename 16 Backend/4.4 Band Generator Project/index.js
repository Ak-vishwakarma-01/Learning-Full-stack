...
app.post("/submit", (req, res) => {
  ...
  const adjlen = Math.floor((Math.random()*(adj.length)));
  const noutlen = Math.floor((Math.random()*(noun.length)));
  app.render("index.ejs",{ adjective: adj[adjlen], noun: noun[noutlen]});
});
